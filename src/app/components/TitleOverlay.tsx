    ...
    <div className="absolute inset-0 z-30 flex flex-col items-center justify-center pointer-events-none">
      ...
      >
        <h1
          ...
          style={{ fontFamily: 'Orbitron, monospace', lineHeight: '1.2' }}
        >
          SEOUL
        </h1>
      </motion.div>
      ...
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1, color: ["#67e8f9", "#e0f2fe", "#67e8f9"] }}
      ...
      >
        <div
          ...
          style={{ fontFamily: 'Orbitron, monospace', boxShadow: '4px 4px 0px rgba(0,0,0,0.5)' }}
        >
          [ TAP TO ENTER ]
        </div>
      </div>
